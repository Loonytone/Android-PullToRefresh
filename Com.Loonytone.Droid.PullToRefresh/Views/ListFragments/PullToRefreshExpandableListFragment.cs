...
namespace Com.Loonytone.Droid.PullToRefresh.Views.ListFragments
{
    ...
    /// <summary>
    /// A sample implementation of how to use <seealso cref="PullToRefreshExpandableListView"/>
    ...
    /// 
    /// </summary>
    public class PullToRefreshExpandableListFragment : PullToRefreshBaseListFragment<PullToRefreshExpandableListView>
	{

		protected override PullToRefreshExpandableListView onCreatePullToRefreshListView(LayoutInflater inflater, Bundle savedInstanceState)
		{
			return new PullToRefreshExpandableListView(Activity);
		}
